...
| **ยิง (Shoot)**     | คลิกเมาส์ซ้าย (Left Click)   |
...
1. **Developer A**: ดูแลระบบฟิสิกส์ การเคลื่อนที่ ระบบอาวุธ และการออกแบบตัวละคร
2. **Developer B**: ดูแลระบบ Wave, State Machine, ระบบเสียง และ UI/UX
